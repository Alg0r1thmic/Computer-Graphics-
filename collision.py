...
floor = MyFloor([0,0,0], 2)
floor1 = MyFloor([0,0,0], 2)
...
def set_initial_position():
    ...
    floor_actor1.SetPosition(-10, floor.pos[1], floor.pos[2])
...
source3.SetXLength(5)
source3.SetYLength(100)
source3.SetZLength(40)
source3.Update()
...
floor_mapper1 = vtk.vtkPolyDataMapper()
floor_mapper1.SetInputData(source3.GetOutput())

#actor
sphere_actor = vtk.vtkActor()
sphere_actor.SetMapper(sphere_mapper)
sphere_actor.GetProperty().SetColor(1, 1, 1.0)
...
floor_actor1 = vtk.vtkActor()
floor_actor1.SetMapper(floor_mapper1)
floor_actor1.GetProperty().SetColor(1, 1, 0.0)
#sphere_actor.GetProperty().SetOpacity(0.7)
floor1.actor = floor_actor1
...
renderer.AddActor(floor_actor1)
